...
<body class="d-flex flex-column h-100">
  ...
  <script type="text/javascript">
    ...
    function PrintElem(nomor, sisa) {
      ...
      mywindow.document.write(
        '<img src="/antrean/assets/img/wifi.svg" width="40" /> </div><div class="number"> Mohon berkenan menunggu. Terima kasih <br />Wifi : IBN-PUBLIK-CAPIL <br />Pass : @capilbtl100</div></div> </div></div></body>'
      );
