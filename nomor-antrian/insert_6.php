...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) {
  ...
  $query = mysqli_query($mysqli, "SELECT max(no_antrian) as nomor FROM tbl_antrian WHERE tanggal='$tanggal' AND loket='6'")
  ...
  $insert = mysqli_query($mysqli, "INSERT INTO tbl_antrian(tanggal, no_antrian,loket, dilayani) 
                                   VALUES('$tanggal', '$no_antrian','6','Belum dipanggil')")
